...
export async function saveComprehensionAssessment({
  ...
  return query(
    `insert into comprehension_assessments (student_id, assessed_date, passage_title, score, level, notes, recorded_by)
     values ($1, $2, $3, $4, $5, $6, $7)`,
    [studentId, assessedDate, passageTitle, score, level, notes, teacherId]
  );
}
