...
<head>
  ...
  <title>Login — ARAL Monitor</title>
...
<div class="wrap">
  ...
  <!-- Teacher badge -->
  <div class="teacher-tag"><span>👩‍🏫 Teacher Portal</span></div>

  <div class="card">
    <div class="card-title">Welcome back</div>
    <div class="card-sub">Sign in to your teacher account</div>
    ...
    <div class="divider">No account yet? <a href="register_teacher.php">Create one here</a></div>
    <div class="divider" style="margin-top:10px;"><a href="index.php">← Return to role selection</a></div>
  </div>
